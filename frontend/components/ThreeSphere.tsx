...
export default function ThreeSphere() {
  return (
    <div className="absolute inset-0 h-full w-full rounded-[2rem] border border-sky-500/10 bg-transparent shadow-soft">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(56,189,248,0.08),transparent_18%),radial-gradient(circle_at_top_right,rgba(56,189,248,0.05),transparent_18%)]" />
    </div>
  );
}
